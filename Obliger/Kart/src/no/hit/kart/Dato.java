...
public class Dato {
	...
	/*
	 * Konstruktør for å lage Dato-objekter fra tekstlig representasjon, på
	 * formen "dd.mm.åååå"
	 */
	...
	public String toString() {
		return (Integer.toString(dag) + "." + Integer.toString(mnd) + "." + Integer.toString(år));
	}
	...
	/*
	 * Sjekk om denne datoen (this) ligger i et skuddår.
	 */
